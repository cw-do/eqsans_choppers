...
#moxaIpAsynPortDriverConfigure( "skf4Port", "10.112.18.30:4004", "10.112.18.30:969", 250, 1.1, 20, 1 )
#asynWaitConnect("skf4Port",10)

## Load record instances
dbLoadRecords( "db/skf4_ioc_sns.db" )
dbLoadRecords( "db/skf4_saveRst.db" )
dbLoadRecords("$(SKFCHOP)/db/softPvs.db","appVer=1-2-3,s=BL6,ta=Chop,ss=Skf4,ChType=1,devType=Serial,ChDist=9507.0,OfsTime=19361.4,OfsAngle=0.0,ChopMod=1,ChMult=1.0,ChOfs=0.0,ChExp=0.0,FreqC1=0,FreqC2=0,DistC1=0,PhaseMode=1,MaxPhaseDelay=165000")
dbLoadRecords("$(SKFCHOP)/db/simDevicePvs.db","s=BL6,ta=Chop,ss=Skf4,port=skf4Port,addr=1,MaxSpeed=60")
#dbLoadRecords("$(SKFCHOP)/db/devicePvs.db","s=BL6,ta=Chop,ss=Skf4,port=skf4Port,addr=1,MaxSpeed=60")
...
# for testing
seq rampWithFixedRate, "SetPointPv=BL6:Chop:Skf4:SpeedSet,ReadBackPv=BL6:Chop:Skf4:MotorSpeedSim,Rate=10,TimeInc=1"
seq copy, "FromPv=BL6:Chop:Skf4:SpeedSet,ToPv=BL6:Chop:Skf4:RunSpeedSetpointSim,Delay=1"
seq rampWithFixedRate, "SetPointPv=BL6:Chop:Skf4:PhaseTimeDelaySet,ReadBackPv=BL6:Chop:Skf4:PhaseAccuracySim,Rate=100,TimeInc=1"
seq copy, "FromPv=BL6:Chop:Skf4:PhaseTimeDelaySet,ToPv=BL6:Chop:Skf4:PhaseTimeDelaySim,Delay=1"
