...
drvAsynIPPortConfigure("mb1tcp", "10.112.12.51:502", 0, 0, 0)
...
dbLoadRecords("$(SKFCHOP)/db/softPvs.db","appVer=1-2-3,s=BL6,ta=Chop,ss=Skf1,ChType=1,devType=Modbus,ChDist=5702.0,OfsTime=19024.3,OfsAngle=0.0,ChopMod=1,ChMult=1.0,ChOfs=0.0,ChExp=0.0,FreqC1=0,FreqC2=0,DistC1=0,PhaseMode=0,MaxPhaseDelay=165000")
dbLoadRecords("$(SKFCHOP)/db/modbusPvs.db","s=BL6,ta=Chop,ss=Skf1,MaxSpeed=60")
